...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DetailedCard = _styledElements.Card.extend(_templateObject);
	
	var DetailedAvatar = _styledElements.Avatar.extend(_templateObject2);
	
	var DetailedName = _styledComponents2.default.h3(_templateObject3);
	
	var DetailedWrapper = _styledElements.DetailWrapper.extend(_templateObject4);
	...
	var UserDetails = function (_React$Component) {
	  ...
	  UserDetails.prototype.componentDidMount = function componentDidMount() {
	    ...
	    (0, _getUsers.getUsers)(this.props.match.params).then(function (user) {
	  ...
	  UserDetails.prototype.render = function render() {
	    var _ref = this.state.currentUser && this.state.currentUser,
	        name = _ref.name,
	    ...
	    return _react2.default.createElement(
	      ...
	      !this.state.currentUser ? _react2.default.createElement(
	        ...
	        { id: name + '-card', animationDelay: 1, duration: 300 },
	        _react2.default.createElement(
	          DetailedCard,
	          null,
	          _react2.default.createElement(DetailedAvatar, { src: avatar }),
	          _react2.default.createElement(
	            DetailedWrapper,
	            null,
	            _react2.default.createElement(
	      ...
	      render: function render(_ref) {
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(_reactRouterDom.Route, {
	            ...
	            key: location.key,
	            path: '/user/:id',
	            component: _userDetails2.default
	          })
	        );
	      }
	    })
...
//# sourceMappingURL=component---src-pages-user-js-56e4470f9422c9f468c4.js.map